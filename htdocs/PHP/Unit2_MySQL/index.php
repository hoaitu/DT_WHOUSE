...
$query_recent_posts = 'SELECT * FROM `posts` ORDER BY created_at DESC LIMIT 6' ;
...
$query_one_posts = 'SELECT * FROM `posts` ORDER BY created_at DESC LIMIT 6, 1' ;
					...
					<div class="col-md-4">
						<div class="post">
							<a class="post-img" href="blog-post.html">
								<!-- thumbnail -->
								<img src="<?php echo $post['thumbnail'] ?>" alt="" width= "300" height= "175.98"></a>
							<div class="post-body">
								<div class="post-meta">
									<!-- //category_id -->
									<a class="post-category cat-3" href="category.html"><?php echo $post['category_id']; ?></a>
				...
				<div class="row">
					<div class="col-md-8">
						...
						<?php } ?>
							...
							<div class="col-md-6">
								<div class="post">
									<a class="post-img" href="blog-post.html"><img src="<?php echo $post['thumbnail'] ?>" alt="" width= "400" height= "250"></a>
									<div class="post-body">
										<div class="post-meta">
											<a class="post-category cat-4" href="category.html"><?php echo $post['category_id']; ?></a>
											<span class="post-date"><?php echo $post['created_at'] ;?></span>
										</div>
										<h3 class="post-title"><a href="blog-post.html"><?php  echo $post['title'] ; ?></a></h3>
									</div>
